...
class _SpeakingPracticeScreenState
  ...
  final bool _isConversationComplete = true;
  ...
  final bool _isTranslationEnabled = false; // 번역 활성화 상태
  final Map<String, String> _translatedMessages = {}; // 메시지별 번역 저장
  final Map<String, bool> _translationStates = {};
